            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-12 mx-auto">
                        <div class="pb-5 mb-5">
                            ...
                            <p>Website Pengaduan Masyarakat ini dibuat sebagai sarana komunikasi dua arah antara
                                masyarakat dan pihak berwenang dalam menyampaikan keluhan, saran, atau laporan terkait
                            ...
                            <p> Website ini dirancang untuk mempermudah proses penanganan pengaduan secara transparan,
                    ...
                    <div class="col-lg-10 col-12 mx-auto">
                        <div class="pb-5 mb-5">
                            <div class="section-title-wrap mb-4">
                                <h4 class="section-title">Tata Cara Pengaduan</h4>
                            </div>
                                ...
                                <div class="col-md-6 col-lg-3">
                                    <div class="card h-100 text-center shadow-sm hover-effect">
                                        <div class="card-body">
                                            ...
                                            <h6 class="card-title fw-bold">Kirim Laporan</h6>
                                            <p class="card-text small">Tulis laporan keluhan Anda dengan jelas.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-3">
                                    <div class="card h-100 text-center shadow-sm hover-effect">
                                        <div class="card-body">
                                            ...
                                            <h6 class="card-title fw-bold">Proses Verifikasi</h6>
                                            <p class="card-text small">Tunggu sampai laporan Anda diverifikasi oleh
                                                admin/petugas.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-3">
                                    <div class="card h-100 text-center shadow-sm hover-effect">
                                        <div class="card-body">
                                            ...
                                            <h6 class="card-title fw-bold">Tindak Lanjut</h6>
                                            <p class="card-text small">Laporan Anda sedang dalam diproses dan ditindak
                                                lanjuti.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-3">
                                    <div class="card h-100 text-center shadow-sm hover-effect">
                                        <div class="card-body">
                                            ...
                                            <h6 class="card-title fw-bold">Selesai</h6>
                                            <p class="card-text small">Laporan pengaduan telah selesai ditindak.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
