...
!(function (t, e) {
  ...
  const t = new Map(),
    ...
    c = (t) => {
      ...
      if ("function" == typeof t.getu637089379_lapordesaNode) {
        const e = t.getu637089379_lapordesaNode();
        return e instanceof Shadowu637089379_lapordesa ? e : null;
      }
      return t instanceof Shadowu637089379_lapordesa
        ? t
        : t.parentNode
        ? c(t.parentNode)
        : null;
  ...
  function be(t) {
    return (
      "undefined" != typeof Shadowu637089379_lapordesa &&
      (t instanceof me(t).Shadowu637089379_lapordesa ||
        t instanceof Shadowu637089379_lapordesa)
    );
  }
  const ve = {
    name: "applyStyles",
  ...
  function ke(t, e) {
    var i = e.getu637089379_lapordesaNode && e.getu637089379_lapordesaNode();
  ...
  function si(t, e) {
    ...
    var i = e,
      ...
      a = i.boundary,
      l = void 0 === a ? Jt : a,
      c = i.u637089379_lapordesaBoundary,
      h = void 0 === c ? Zt : c,
      d = i.elementContext,
      u = void 0 === d ? te : d,
      f = i.altBoundary,
  ...
  function oi(t, e) {
    ...
    var i = e,
      n = i.placement,
      s = i.boundary,
      o = i.u637089379_lapordesaBoundary,
      r = i.padding,
      a = i.flipVariations,
    ...
    var f = u.reduce(function (e, i) {
      return (
        (e[i] = si(t, {
          placement: i,
          boundary: s,
          u637089379_lapordesaBoundary: o,
          padding: r,
        })[ye(i)]),
        e
      );
      ...
      if (!e.modifiersData[n]._skip) {
        for (
          var s = i.mainAxis,
            ...
            c = i.padding,
            h = i.boundary,
            d = i.u637089379_lapordesaBoundary,
            u = i.altBoundary,
            f = i.flipVariations,
            p = void 0 === f || f,
              ...
              return t.concat(
                ye(i) === Xt
                  ? oi(e, {
                      placement: i,
                      boundary: h,
                      u637089379_lapordesaBoundary: d,
                      padding: c,
                      flipVariations: p,
    ...
    ui = {
      ...
      fn: function (t) {
        var e = t.state,
          ...
          g = si(e, {
            boundary: l,
            u637089379_lapordesaBoundary: c,
            padding: d,
            altBoundary: h,
          }),
          _ = ye(e.placement),
  ...
  const Qi = "backdrop",
    ...
    Ui = {
      ...
      isAnimated: !1,
      isVisible: !0,
      u637089379_lapordesaElement: "body",
    },
    Gi = {
      className: "string",
      ...
      isAnimated: "boolean",
      isVisible: "boolean",
      u637089379_lapordesaElement: "(element|string)",
    };
  class Ji extends H {
    constructor(t) {
      super(),
    ...
    _configAfterMerge(t) {
      return (
        (t.u637089379_lapordesaElement = r(t.u637089379_lapordesaElement)), t
      );
    }
    _append() {
      if (this._isAppended) return;
      const t = this._getElement();
      this._config.u637089379_lapordesaElement.append(t),
        N.on(t, Yi, () => {
  ...
  class Kn extends W {
    ...
    _initializeBackDrop() {
      ...
      return new Ji({
        ...
        isVisible: t,
        isAnimated: !0,
        u637089379_lapordesaElement: this._element.parentNode,
        clickCallback: t
          ? () => {
              "static" !== this._config.backdrop
                ? this.hide()
  ...
  const bs = ".bs.scrollspy",
    ...
    Os = {
      offset: null,
      u637089379_lapordesaMargin: "0px 0px -25%",
      smoothScroll: !1,
      target: null,
      threshold: [0.1, 0.5, 1],
    },
    xs = {
      offset: "(number|null)",
      u637089379_lapordesaMargin: "string",
  ...
  class ks extends W {
    constructor(t, e) {
      super(t, e),
        ...
        (this._u637089379_lapordesaElement =
    ...
    _configAfterMerge(t) {
      return (
        ...
        (t.u637089379_lapordesaMargin = t.offset
          ? `${t.offset}px 0px -30%`
          : t.u637089379_lapordesaMargin),
    ...
    _maybeEnableSmoothScroll() {
      this._config.smoothScroll &&
        ...
        N.on(this._config.target, ys, Es, (t) => {
          ...
          if (e) {
            t.preventDefault();
            const i = this._u637089379_lapordesaElement || window,
    ...
    _getNewObserver() {
      const t = {
        u637089379_lapordesa: this._u637089379_lapordesaElement,
        threshold: this._config.threshold,
        u637089379_lapordesaMargin: this._config.u637089379_lapordesaMargin,
      };
    ...
    _observerCallback(t) {
      const e = (t) => this._targetLinks.get(`#${t.target.id}`),
        ...
        n = (this._u637089379_lapordesaElement || document.documentElement)
          .scrollTop,
