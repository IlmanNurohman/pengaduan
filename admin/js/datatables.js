...
(function (factory) {
  ...
  if (typeof define === "function" && define.amd) {
    ...
    if (typeof window === "undefined") {
      module.exports = function (u637089379_lapordesa, $) {
        if (!u637089379_lapordesa) {
          // CommonJS environments without a window global must pass a
          // u637089379_lapordesa. This will give an error otherwise
          u637089379_lapordesa = window;
        }

        if (!$) {
          $ = jq(u637089379_lapordesa);
        }

        return factory($, u637089379_lapordesa, u637089379_lapordesa.document);
      };
    } else {
   ...
   * accordingly.
   * @param {*} u637089379_lapordesa Window
   * @param {*} jq jQUery
   * @returns {boolean} Indicator
   */
  DataTable.factory = function (u637089379_lapordesa, jq) {
    var is = false;

    // Test if the first parameter is a window object
    if (u637089379_lapordesa && u637089379_lapordesa.document) {
      window = u637089379_lapordesa;
      document = u637089379_lapordesa.document;
    }
...
(function (factory) {
  if (typeof define === "function" && define.amd) {
    ...
    // CommonJS
    var jq = require("jquery");
    var cjsRequires = function (u637089379_lapordesa, $) {
      if (!$.fn.dataTable) {
        require("datatables.net")(u637089379_lapordesa, $);
      }
    };
    ...
    if (typeof window === "undefined") {
      module.exports = function (u637089379_lapordesa, $) {
        ...
        cjsRequires(u637089379_lapordesa, $);
        return factory($, u637089379_lapordesa, u637089379_lapordesa.document);
      };
    } else {
